<template>
  <div>
    <div class="card" style="margin-bottom: 5px">
      ...
      <el-input clearable @clear="load" v-model="data.content" :prefix-icon="Search" placeholder="请输入内容关键字" style="width: 240px;margin-left: 5px"></el-input>
      ...
      <el-table :data="data.tableData" @selection-change="handleSelectionChange" style="width: 100%"
        ...
        <el-table-column fixed="right" label="操作" width="150" :align="'center'" >
          <template #default="scope">
            ...
            <el-button link type="primary" size="small" icon="delete" style="color: #ff4646" @click="del(scope.row.noticeId)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
    ...
    <!-- 表单   -->
    <el-dialog title="系统公告信息" v-model="data.formVisible" width="30%" destroy-on-close>
      <!-- 表单-->
      <el-form  ref="formRef" :model="data.form" :rules="data.rules" label-width="100px" style="padding: 20px 30px 20px 3px">
        ...
        <el-form-item label="公告内容：" prop="content">
          <el-input :rows="4" v-model="data.form.content" type="textarea" placeholder="请输入内容" size="medium"/>
        </el-form-item>
      </el-form>
      <!--弹窗底部按钮-->
      <template #footer>
